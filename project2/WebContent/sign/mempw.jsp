            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">고객지원</a></li>
...
<div class="head">
	...
	<form action="memlogin.html">
    <div class="form-group">
    <%
    	for (int i = 0; i < list.size(); i++) {
    	SignVO vo = list.get(i);
    %>
	<input type="text" class="form-control" name="pw"  id="pw" value = "<%= vo.getPw()%>">
	<%
		}
	%>
    </div>
