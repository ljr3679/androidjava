...
<div class="head">        
<div id="img" class="head" style="background-image: url('images/3.JPG')">
	<label>AppleMango ID</label>
	<h1>AppleMango 서비스센터</h1>
</div>
</div>
<div class="map_wrap">
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    <input type="hidden" value="애플 서비스센터" id="keyword" size="15"> 
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d73e8fb1376ba24961f9614b831082b4&libraries=services"></script>
<script>
// 마커를 담을 배열입니다
var markers = [];
