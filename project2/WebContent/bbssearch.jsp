		...
		<div class="container">
			<div class="row">
				<table class="table table-striped"
					...
					<thead>
						<tr>
							<th style="background-color:  #2c3e50; color:white;  text-align: center;">번호</th>
							<th style="background-color:  #2c3e50; color:white;  text-align: center;">제목</th>
							<th style="background-color:  #2c3e50; color:white;  text-align: center;">내용</th>
							<th style="background-color:  #2c3e50; color:white;  text-align: center;">작성자</th>
							<th style="background-color:  #2c3e50; color:white;  text-align: center;">작성일</th>
							<th style="background-color:  #2c3e50; color:white;  text-align: center;">조회수</th>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td style="background-color: white;"><a href="bbsview.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle()%></a><br>
							</td>
							<td style="background-color: white;"><a href="bbsview.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsContent()%></a></td>
							...
							<td style="background-color: white;"><%=list.get(i).getBbsCount()%></td>
						</tr>
						<%
							}
						%>
