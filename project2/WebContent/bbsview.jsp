		...
		<div class="head">　</div>
				<table class="table table-striped"
					...
					<thead>
						<tr>
							<th colspan="3"
								style="background-color: #2c3e50; text-align: center;">글 보기 </th>
						</tr>
					</thead>
				...
				<a href = "bbs.jsp" style="background-color: #2c3e50;" class="btn btn-primary">목록</a>

				<%
				//글작성자 본인일시 수정 삭제 가능 
					if(id != null && id.equals(bbs.getId())){
				%>
						<a style="background-color: #2c3e50;" href="bbsupdate.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">수정</a>
						<a style="background-color: #2c3e50;" href="bbsdeleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제</a>
				<%					
					}
				%>
		</div>
