...
<body>
	<nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img style="width: 50px" src="img/full_color.png" alt="" />AppleMANGO</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Products</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">Music</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="customer.jsp">고객지원</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a style="padding: 5px" class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about"><img style="width: 30px" src="img/cart.png" alt="" /></a></li>
	...
	<a href="main.html" class="btn btn-success btn-arrow-left">AppleMango 메 인</a>
...
<div class="head">
  <div id="img" class="form-group" style="background-image: url('images/3.JPG')">
	<label>AppleMango search</label>
     <input type="text" class="form-control" name="bbstitle"  id="search"
      placeholder="AppleMang ID" >
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="memlogin.html">로그인</a></li>
							<li><a href="memsign.html">회원가입</a></li>
						</ul></li>
				</ul>
				<%
					} else {
		...
		<div class="container">
			<div class="row">
				<table class="table table-striped"
					...
					<thead>
						<tr>
							...
							<th style="background-color:  #2c3e50; color:white; width:10%; center;">제목</th>
							<th style="background-color:  #2c3e50; color:white; width:40%; center;">내용</th>
							<th style="background-color:  #2c3e50; color:white; width:15%; center;">작성자</th>
							<th style="background-color:  #2c3e50; color:white; width:15%; center;">작성일</th>
							<th style="background-color:  #2c3e50; color:white; width:10%; center;">조회수</th>
						</tr>
					</thead>
					<tbody>
					...
					<tr>
							...
							<td style="background-color: white; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><a href="bbsview.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsTitle()%></a><br>
							</td>
							<td style="background-color: white; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><a href="bbsview.jsp?bbsID=<%=list.get(i).getBbsID()%>"><%=list.get(i).getBbsContent()%></a></td>
							...
							<td style="background-color: white; height:10%; "><%=list.get(i).getBbsCount()%></td>
						</tr>
						<%
							}
						%>
				...
				<%
					if (pageNumber != 1) {
				%>
				<a style="background-color: #2c3e50;" href="bbs.jsp?pageNumber=<%=pageNumber - 1%>"
