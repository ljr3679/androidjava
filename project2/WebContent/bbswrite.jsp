			...
			<div class="head">
				<table class="table table-striped"
					...
					<thead>
						<tr>
							<th colspan="2"
								style="background-color: #2c3e50; text-align: center; color:white; width:100%;">게시판
								글쓰기 양식</th>
						</tr>
					</thead>
					<tbody>
				...
				<input style="background-color:  #2c3e50;" type="submit" class="btn btn-primary pull-right" value="글쓰기" />
			</form>
		</div>
	</div>
