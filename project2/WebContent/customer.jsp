...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
						href="#contact">Music</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
						href="customer.jsp">고객지원</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a style="padding: 5px"
						class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
						href="#about"><img style="width: 30px" src="img/cart.png"
							alt="" /></a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"
						href="memlogin.html">Login</a></li>
				</ul>
			</div>
		</div>
	</nav>
	...
	<a href="bbs.jsp" class="btn btn-success btn-arrow-left">AppleMango
		게시판</a>
	<a href="main.html" class="btn btn-success btn-arrow-left">AppleMango
		메 인</a>
	<div class="container">
<div class="head">
　
		...
		<table class="table table-striped">
			<tr>
				<th style="background-color: white; text-align: left;"><img
					src="images/aa.JPG">
					<h1>궁금한 점이 있으십니까?</h1>
					<p>커뮤티니에 물어보세요. AppleMango 지원 커뮤니티에서 답변을 얻을 수 있습니다.</p> <a
					href="bbs.jsp">AppleMango 지원커뮤니티에 문의하기</a></th>

				<th style="background-color: white; text-align: left;"><img
					src="images/ss.JPG">
					<h1>고장나셨나요?</h1>
					<p>수리센터 위치를 알려 드리겠습니다.</p> <a href="servicecenter.jsp">수리센터 찾기</a>
				</th>
			</tr>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						서울특별시 마포구 신촌로 94, <br /> 7층(노고산동, 그랜드플라자)
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright © AppleMango 2020</small>
		</div>
	</div>
