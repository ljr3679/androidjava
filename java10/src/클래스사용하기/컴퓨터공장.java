...
public class 컴퓨터공장 {
	...
	public static void main(String[] args) {
		...
		//없으면 다른 패키지에서 찾게됨.
		//다른패키지에 있는 객체를 사용하는 경우는
		//import로 경로를 면시해주어야한다.
		//자동import : 1)자동완성  2)마우스를 올리고 (f2) 3)컨트롤+쉬프트+o(영문)
		컴퓨터 com1 = new 컴퓨터();
		...
		System.out.println("com1의 크기는 " + com1.size);
		...
		System.out.println("com2의 크기는 " + com2.size);
