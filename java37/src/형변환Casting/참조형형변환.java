...
public class 참조형형변환 {
	...
	public static void main(String[] args) {
		...
		//모든 타입을 묶을수 있음. 크기가 유동
		list.add("홍길동");
		//Object(큰)<-String(작) : 자동 형변환
		//업캐스팅
		list.add(100);
		...
		//업캐스팅(자동형변환)으로 String을 Object르로 형변환하여 넣은 것은
		//꺼냈을 때 Object꺼내면 String에서 추가된 기능을 쓸수 없다.
		//꺼낼 때, String으로 형변환하여 꺼내야 한다.
		//Object name = list.get(0); 이렇게 하면 안됨.
